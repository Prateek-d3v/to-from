...
def fetch_product_details(product_id):
    try:
        ...
        if data.get("image") and len(data["image"]) > 0:
            ...
            return "https://via.placeholder.com/100"  # Fallback image URL
        ...
        if response.status_code == 200:
            ...
            for idx, product in enumerate(products_info):
                ...
                with col:
                    ...
                    st.image(image_url, width=150, caption=f"Rank: {product.get('rank', 'No rank')}")
            ...
            for idx, debug_item in enumerate(debug_info):
                ...
                with col:
                    ...
                    st.image(image_url, width=150, caption=debug_item.get("name", "No name provided"))
