...
# Example usage:
input_json_file = r'C:\Users\NAGA PRASSAD\Desktop\to-from\files\Cleaned_GPT_Attributes.json'  # Replace with your input JSON file path
output_json_file = 'attributes.txt'  # Replace with desired output JSON file path
